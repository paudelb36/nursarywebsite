...
if (isset($_POST['update_product'])) {
   ...
   $stock_quantity = mysqli_real_escape_string($conn, $_POST['stock_quantity']); // Added stock quantity

   mysqli_query($conn, "UPDATE `products` SET name = '$name', details = '$details', price = '$price', stock_quantity = '$stock_quantity' WHERE id = '$update_p_id'") or die('query failed');
...
<section class="update-product">
   ...
   ?>
         <form action="" method="post" enctype="multipart/form-data">
            ...
            <input type="number" min="0" class="box" value="<?php echo $fetch_products['stock_quantity']; ?>" required placeholder="Update stock quantity" name="stock_quantity"> <!-- Added stock quantity field -->
